 ...
 */
class BoardsRecyclerAdapter(private val boards: ArrayList<Board>) : RecyclerView.Adapter<BoardsRecyclerAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun bindView(board: Board) {
            ...
            itemView.boardImage.setImageDrawable(when (board.syl_id) {
